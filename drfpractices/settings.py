"""
Django settings for drfpractices project.
...
SECRET_KEY = 'django-insecure-dcnsp*+&_6(+wbu(d-fx74jibndzmio!evq6(xnnn$gew12yft'
...
ROOT_URLCONF = 'drfpractices.urls'
...
WSGI_APPLICATION = 'drfpractices.wsgi.application'
